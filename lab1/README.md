...
- A program contains 4 billions instructions, each taking 2 CPU cycles, and the CPU is 3GHz. What is the optimal exectuion time ? (_we wil discuss clock time vs time spent, and cost of cache misses, and the fact that pipeling allows to go faster that the expected optimal throughput_)
...
> Task : Connect the dots: Watch the following awesome videos on CPU pipeline : [pipelining](https://www.youtube.com/watch?v=otSXgSp-8EY&index=60&list=PLAwxTw4SYaPmqpjgrmf4-DGlaeV0om4iP), [Pipelining in a processor](https://www.youtube.com/watch?v=eVRdfl4zxfI&list=PLAwxTw4SYaPmqpjgrmf4-DGlaeV0om4iP&index=61) - Look also at the [additional quizzes on pipelining for laundry and instructions](https://www.youtube.com/watch?v=QiJKYkCSesM&list=PLAwxTw4SYaPmqpjgrmf4-DGlaeV0om4iP&index=62) in the same videos series.
...
### Programmings hack for HPP

[Sign flip optimization](https://nfrechette.github.io/2019/05/08/sign_flip_optimization/) 

(Feel free to pull request your links !)
